...
const desc =
  "Di Mata Kuliah Pemrograman Perangkat Bergerak ini, \
...
let interestsButton = interests.map((interest, index) => {
  return <button key={index}>{interest}</button>;
});
      ...
      <div className={`${styles.intro} ${styles.main}`} white-space="pre-line">
        <div className={styles.overview}>
          ...
          <div className={styles.aboutme}>
            <h3>About Me</h3>
            <p>Saya Mahasiswa Rekayasa Perangkat Lunak di
              Institut Teknologi Sepuluh Nopember semester 3. Saya memiliki ketertarikan pada pengembangan perangkat lunak dan senang mentransformasikan ide menjadi solusi yang fungsional. Saat ini, fokus saya adalah mengeksplorasi arsitektur sistem, serta membangun proyek-proyek praktis yang relevan dengan kebutuhan industri.</p>
          </div>
          <div className={styles.social}>
            <a href="https://github.com/Fauzanium">
              <Image src="./github.svg" width={36} height={36} alt="" />
            </a>

            <a href="https://instagram.com/fauzanium_">
